...
import pandas as pd  # pandas isn't used, consider removing
from dataclasses import dataclass  # Not directly used, consider removing
from contextlib import contextmanager  # Not used, consider removing
...
class RLSCreateforUsers:
    ...
    def __init__(self):
        ...
        self.page_title = "Create Row Level Policy"
        self.headers()
